---
title: "Setting up JWT Authentication for Non-Interactive Use"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Setting up JWT Authentication for Non-Interactive Use}
...
library(meetupr)
query <- 'query { self { id } }'
result <- meetup_template_query(query)
