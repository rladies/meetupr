# Contributing to meetupr

This outlines how to propose a change to meetupr. For more detailed info
...
- We recommend that you create a Git branch for each pull request
  (PR).  
- Look at the Travis build status before and after making changes. The
...
Conduct](http://rladies.org/meetupr/CODE_OF_CONDUCT.md). By
