...
knitr::opts_chunk$set(
  ...
  comment = "#>",
  fig.path = "README-",
  eval = meetupr::meetup_auth_status(silent = TRUE)
)

```

# meetupr <img src="man/figures/logo.png" align="right" alt="meetupr hex logo made by Zane Dax @StarTrek_Lt" width="138.5" />
